const responsive = {
  ...
  '@media (max-width: 1253px)': {
    '.inputLabel': { marginBottom: '36px', width: '100% !important' },
  },
  ...
  '@media (max-width: 350px)': {
    ...
    '.modal-overlay .modal-content div .firstButton, .modal-overlay .modal-content div .secondButton':
      {
        padding: '5px 25px',
      },
  },
